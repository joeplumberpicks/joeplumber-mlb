...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run fast PA-based game simulation with dynamic starter hook.")
...
def main() -> None:
    ...
    print(f"away_starter_bf_cap_override={args.away_starter_bf_cap}")
    print(f"home_starter_bf_cap_override={args.home_starter_bf_cap}")
    print("")
