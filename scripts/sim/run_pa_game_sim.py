...
from src.sim.pa_simulator import simulate_single_game, summarize_sim_results
from src.utils.config import load_config
from src.utils.drive import resolve_data_dirs


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run PA-based game simulation.")
...
def main() -> None:
    ...
    out_csv = Path(args.out_csv) if args.out_csv else outputs_dir / "pa_game_sim_results.csv"
    out_json = Path(args.out_json) if args.out_json else outputs_dir / "pa_game_sim_summary.json"
