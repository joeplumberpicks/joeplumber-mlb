...
ENGINE = "nrfi_xgb"
MART_FILE = "nrfi_features.parquet"
TARGET_COL = "target_nrfi"

def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train NRFI scaffold model.")
...
def main() -> None:
    ...
    log_header("scripts/train/train_nrfi_xgb.py", repo_root, config_path, dirs)
