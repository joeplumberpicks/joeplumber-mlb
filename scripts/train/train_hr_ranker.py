...
ENGINE = "hr_ranker"
MART_FILE = "hr_features.parquet"
TARGET_COL = "target_hr"

def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train HR ranker scaffold model.")
...
def main() -> None:
    ...
    log_header("scripts/train/train_hr_ranker.py", repo_root, config_path, dirs)
