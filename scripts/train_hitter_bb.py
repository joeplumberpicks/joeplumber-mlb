...
from src.models.train_hitter_bb import run_smoke_test, train_hitter_bb_from_paths


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train hitter BB model.")
    ...
    p.add_argument("--model-out", type=str, default=None, help="default data/models/hitter_bb_{season}/")
...
def main() -> None:
    setup_logging()
    a = parse_args()
    logger = logging.getLogger("train_hitter_bb")
    ...
    model_out = Path(a.model_out) if a.model_out else Path(f"data/models/hitter_bb_{a.season}")

    train_hitter_bb_from_paths(
        season=a.season,
