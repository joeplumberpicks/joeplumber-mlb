...
from src.models.train_hitter_rbi import run_smoke_test, train_hitter_rbi_from_paths


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train hitter RBI model.")
    ...
    p.add_argument("--model-out", type=str, default=None, help="default data/models/hitter_rbi_{season}/")
...
def main() -> None:
    setup_logging()
    a = parse_args()
    logger = logging.getLogger("train_hitter_rbi")
    ...
    model_out = Path(a.model_out) if a.model_out else Path(f"data/models/hitter_rbi_{a.season}")

    train_hitter_rbi_from_paths(
        season=a.season,
