...
from src.features.pitcher_mix import build_and_write_pitcher_mix


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build Statcast pitcher pitch-mix and outcome quality features."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional output parquet path (default: data/processed/statcast/pitcher_mix_{season}.parquet)",
    )
...
def main() -> None:
    setup_logging()
    args = parse_args()
    logger = logging.getLogger("build_pitcher_mix")
