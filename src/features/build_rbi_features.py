...
def _build_team_context(lineups: pd.DataFrame, batter_roll: pd.DataFrame) -> pd.DataFrame:
    ...
    slot_col = _pick_col(lu, ["lineup_slot", "batting_order", "order_spot", "slot"], required=False)
    ...
    # hitters ahead in order are most useful for RBI context
...
def build_rbi_features(
    ...
    # team context from lineup mates
    ...
    # helper matchup/context features
